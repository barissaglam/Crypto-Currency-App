object Dependencies {
    ...
    const val jUnitExtension = "androidx.test.ext:junit:${Versions.extJUnitVersion}"
    ...
    const val inset = "com.google.accompanist:accompanist-insets:${Versions.accompanistVersion}"
